...
<script>
  layui.use(['laydate','table','form'], function(){
	  ...
	  table.render({
	    elem: '#test'
	    ,url:'${pageContext.request.contextPath}/mobility/selectMobility_r'
	    ...
	    ,cols: [[
	      ...
	      ,{field: 'id_r', title: 'ID', width:50}
	      ,{field: 'name_r', title: '姓名',edit: 'text', width:90}
	      ,{field: 'telephone_r', title: '联系电话',edit: 'text', width:130}
	      ,{field: 'reason_r', title: '出入事由',edit: 'text',event: 'setReason', style:'cursor: pointer;'} 
	      ,{field: 'outtime_r', title: '外出时间',edit: 'text',event:'edit_outTime',data_field:'outtime_r'
	    	  ,width: 170, templet : "<div>{{layui.util.toDateString(d.outtime_r, 'yyyy-MM-dd HH:mm:ss')}}</div>"}
	      ,{field: 'out_temp', title: '体温',edit: 'text', width: 60}
	      ,{field: 'returntime_r', title: '返回时间',edit: 'text',event:'edit_returnTime',data_field:'returntime_r'
	    	  ,width: 170,templet : "<div>{{layui.util.toDateString(d.returntime_r, 'yyyy-MM-dd HH:mm:ss')}}</div>"}
	      ,{field: 'return_temp', title: '体温',edit: 'text', width: 60}
	    ...
	    switch(obj.event){
	      ...
	      case 'LAYTABLE_SEARCH': //table重载
	    	  ...
	    	  table.reload('test', { //表格的id
                  url:'${pageContext.request.contextPath}/mobility/selectMobilityByNT_r?name_r='+uName+'&date='+date,
              });
	      break; 
	      //自定义头工具栏右侧图标 - 提示
	      case 'LAYTABLE_TIPS':
	  ...
	  table.on('tool(test)', function(obj){
	    var data = obj.data;
		var id = data['id_r'];//获取选中的id
		
	    //console.log(obj)
	    if(obj.event === 'del'){
	      layer.confirm('确定删除吗', function(index){
	        obj.del();
	        window.location.href="${pageContext.request.contextPath}/mobility/delMobility_rById?id_r="+id;
	        layer.close(index);
	      });
	    } else if(obj.event === 'update'){
	    	$.ajax({
				url   :"${pageContext.request.contextPath }/mobility/updateMobility_rById",
				type  :"post",
	...
	form.on('submit(demo2)', function (data) {
		$.ajax({
			url   :"${pageContext.request.contextPath }/mobility/insertMobility_r",
			type  :"post",
...
<div class="box box-primary">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input name="name_r" class="layui-input" type="text" placeholder="请输入" autocomplete="off" lay-verify="required">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">联系电话</label>
    <div class="layui-input-inline">
      <input name="telephone_r" class="layui-input" type="text" placeholder="请输入" autocomplete="off" lay-verify="required">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      	...
      	<div class="layui-input-block">
        	<input name="outtime_r" id="outTime" class="layui-input" type="text" autocomplete="off">
      	</div>
    </div>
    <div class="layui-inline">
     	<label class="layui-form-label">体温</label>
      	<div class="layui-input-inline" style="width: 100px;">
        	<input name="out_temp" class="layui-input" type="text" autocomplete="off">
      	</div>
     </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      	...
      	<div class="layui-input-block">
        	<input name="returntime_r" id="returnTime" class="layui-input" type="text" autocomplete="off">
      	</div>
    </div>
    <div class="layui-inline">
     	<label class="layui-form-label">体温</label>
      	<div class="layui-input-inline" style="width: 100px;">
        	<input name="return_temp" class="layui-input" type="text" autocomplete="off">
      	</div>
     </div>
  </div>
  
  <div class="layui-form-item layui-form-text">
    <label class="layui-form-label">出入事由</label>
    <div class="layui-input-block">
      <textarea name="reason_r" class="layui-textarea" placeholder="请输入内容"></textarea>
    </div>
  </div>
