...
<script>
  layui.use(['table','form','laydate'], function(){
	  ...
	  table.render({
	    elem: '#test'
	    ,url:'${pageContext.request.contextPath}/purchase/selectAllbuy'
	    ...
	    ,cols: [[
	      ...
	      ,{field: 'describe', title: '所需物品',event: 'detailed'}
	      ,{field: 'vtid', title: '志愿者',templet:'#volunteers_name'}
	      ,{field: 'abtime', title: '完成时间',width: 165
	    	  	,templet : '#complete_t'}
	      ,{field: 'complete_b', title: '服务状态',templet:'#setExamine'}
	  ...
	  table.on('tool(test)', function(obj){
	    ...
	    if(obj.event === 'del'){
	      layer.confirm('确定删除吗', function(index){
	    	...
	    	if(data['vtid'] != 0){
	    		$.ajax({
					url   :"${pageContext.request.contextPath }/purchase/updateAllbuyById",
					type  :"post",
	    	 ...
	    	 $.ajax({
					url   :"${pageContext.request.contextPath }/purchase/updateAllbuy_c",
					type  :"post",
					data  :JSON.stringify(data),
					contentType :"application/json",
					dataType :"json",
