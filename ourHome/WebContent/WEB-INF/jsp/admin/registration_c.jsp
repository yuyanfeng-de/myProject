...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<script id="toolbarDemo" type="text/html">
			...
			<input type="text" id="search_time" style="width:200px;float:right;height:30px;" placeholder="请输入时间" autocomplete="off" class="layui-input">
...
<script>
  layui.use(['laydate','table','form'], function(){
	  ...
	  table.render({
	    elem: '#test'
	    ,url:'${pageContext.request.contextPath}/mobility/selectAllMobility_c'
	    ...
	    ,cols: [[
	      ...
	      ,{field: 'id_c', title: 'ID', width:50}
	      ,{field: 'telephone_c', title: '联系电话',edit: 'text', width:130}
	     
	      ,{field: 'in_time', title: '进入时间',edit: 'text',event:'edit_outTime',data_field:'outtime_r'
	    	  ,width: 170, templet : "<div>{{layui.util.toDateString(d.outtime_r, 'yyyy-MM-dd HH:mm:ss')}}</div>"}
	      ,{field: 'reason_c', title: '出入事由',edit: 'text',event: 'setReason', style:'cursor: pointer;'} 
	      ,{field: 'out_time', title: '离开时间',edit: 'text',event:'edit_returnTime',data_field:'returntime_r'
	    ...
	    switch(obj.event){
	      ...
	      case 'LAYTABLE_SEARCH': //table重载
	    	  ...
	    	  table.reload('test', { //表格的id
                  url:'${pageContext.request.contextPath}/mobility/selectMobilityByT_c?date='+date,
              });
	      break; 
	      //自定义头工具栏右侧图标 - 提示
	      case 'LAYTABLE_TIPS':
	  ...
	  table.on('tool(test)', function(obj){
	    var data = obj.data;
		var id = data['id_c'];//获取选中的id
		
	    //console.log(obj)
	    if(obj.event === 'del'){
	      layer.confirm('确定删除吗', function(index){
	        obj.del();
	        window.location.href="${pageContext.request.contextPath}/mobility/delMobility_c?id_c="+id;
	        layer.close(index);
	      });
	    } else if(obj.event === 'update'){
	    	$.ajax({
				url   :"${pageContext.request.contextPath }/mobility/updateMobility_c",
				type  :"post",
	...
	form.on('submit(demo2)', function (data) {
		$.ajax({
			url   :"${pageContext.request.contextPath }/mobility/insertMobility_c",
			type  :"post",
...
<div class="box box-primary">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input name="telephone_c" class="layui-input" type="text" placeholder="请输入" autocomplete="off" lay-verify="required">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      	...
      	<div class="layui-input-block">
        	<input name="in_time" id="outTime" class="layui-input" type="text" autocomplete="off">
      	</div>
    </div>
  </div>
   ...
   <div class="layui-form-item layui-form-text">
    ...
    <div class="layui-input-block">
      <textarea name="reason_c" class="layui-textarea" placeholder="请输入内容"></textarea>
    </div>
  </div>
  ...
  <div class="layui-form-item">
    <div class="layui-inline">
      	...
      	<div class="layui-input-block">
        	<input name="out_time" id="returnTime" class="layui-input" type="text" autocomplete="off">
      	</div>
    </div>
  </div>
